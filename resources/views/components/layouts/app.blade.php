...
<body>
    ...
    <div id="warpper" class="nav-fixed">
        <nav class="topnav shadow navbar-light bg-white d-flex">
            <div class="navbar-brand"><a href="?">MUNDANA ADMIN</a></div>
            <div class="nav-right ">
                ...
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="{{route('post.show')}}" wire:navigate>Danh sách</a></li>
                            <li><a href="{{route('cat.add')}}" wire:navigate>Danh mục</a></li>
                        </ul>
                    </li>
                    {{-- <li class="nav-link">
